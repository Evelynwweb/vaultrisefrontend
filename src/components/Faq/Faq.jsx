    ...
    const [faqs,setFaqs] = useState([
        {
            id:1,
            active:true,
            question:'What is VAULTRISEGROUP?',
            answer:"VAULTRISEGROUP is an online platform that maximizes the slight differences in prices of global forex exchange rate and investment in gold stock, real estate, crude oil and agro-tech to inturn satisfy her clients.",
        },
        {
            id:2,
            active:false,
            question:'where does the investment go into?',
            answer:"VAULTRISEGROUP reinvests the funds generated from this platform, into real estate, gold stock investment, agro-tech industries and oil exploration industries around the world. these industries generate enough revenue to constantly satisfy the client's returns, and keep the company running",
        },
        {
            id:3,
            active:false,
        ...
        },
        {
            ...
            answer:'VAULTRISEGROUP supports at least 3 crypto currencies for transactions which include BTC, USDT, ETHEREUM. We plan on supporting more crypto currencies in the near future.',
        },
    ])
    ...
    <div className='faq-section' id='faq'>
        <div className="faq-wrapper">
            <div className="why-choose-us-text-container faq-p">
                ...
                {/* <p data-aos="fade-up">
                We’ve provided some information about VAULTRISEGROUP, VAULTRISEGROUP Plans, cryptocurrencies, and few other common questions you might want to ask. If you have any other questions, contact our live support system or email address.
                </p> */}
            </div>
        </div>
